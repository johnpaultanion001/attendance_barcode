...
<table style="width: 100%; margin-bottom: 20px;">
	<tbody>
		<tr>
			<td class="text-right" style="width: 10%"><img style="width: 100px" src="<?php echo URL; ?>shs.png" /></td>
			<td style="width: 80%">
				<h2 class="text-center text-bold">ICCT College</h2>
				<h3 class="text-center text-bold">AY: <?php echo $model->currentSchoolYear(); ?></h3>
			</td>
			<td style="width: 10%"><img style="width: 100px" src="<?php echo URL; ?>shs.png" /></td>
		</tr>
	</tbody>
</table>
