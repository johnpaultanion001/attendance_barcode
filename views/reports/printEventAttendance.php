...
<table style="width: 100%; margin-bottom: 20px;">
	<tbody>
		<tr>
			<td class="text-right" style="width: 25%"><img style="width: 100px" src="<?php echo URL; ?>shs.png" /></td>
			<td style="width: 50%">
				<h2 class="text-center text-bold">ICCT College</h2>
			...
			<td style="width: 25%"><img style="width: 100px" src="<?php echo URL; ?>shs.png" /></td>
		</tr>
	</tbody>
</table>
