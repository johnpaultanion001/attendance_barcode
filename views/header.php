...
<head>
	...
	<link rel="stylesheet" href="<?php echo URL . "public" ?>/assets/adminlte/plugins/select2/select2.min.css">
	<?php endif; ?>
	<!-- Theme style -->
...
<body class="hold-transition <?php echo (Session::get('loggedIn')) ? "skin-blue sidebar-mini": "login-page"; ?><?php echo isset($this->bodyClass) ? $this->bodyClass : ""; ?>"><?php echo "\n"; ?>
<div class="wrapper">